# OmniSwarm $OMNI Token Ledger v0.1 - 18 Şubat 2026
...
class OmniTokenLedger:
    ...
    def distribute_royalty(
        ...
        Splits total_amount according to the 60/20/20 formula.
        ...
        self.total_distributed = round(
            self.total_distributed + discovery_amount + node_amount + dev_amount,
            8,
        )
